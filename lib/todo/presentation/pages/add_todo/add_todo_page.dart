            ...
            children: [
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return CategoryCard(
                      ...
                      () => BlocProvider.of<AddTodoBloc>(context)
                          .add(CategoryChanged(category.name)),
                    );
                  },
                ),
              ),
                ...
                child: Column(
                  children: [
                    ListTile(
                      ...
                      onTap: () => BlocProvider.of<AddTodoBloc>(context)
                          .add(DateTimeClickEvent()),
                    ),
                    ListTile(
                      leading: SvgPicture.asset(
              ...
              Container(
                ...
                child: PrimaryButton(
                  ...
                  primaryColor,
                  () => BlocProvider.of<AddTodoBloc>(context).add(
                      AddTodoClickEvent(titleController?.text ?? "",
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
                color: Colors.black54.withOpacity(0.17),
